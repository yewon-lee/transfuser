...
#export ROUTES=leaderboard/data/training_routes/routes_town07_tiny.xml
...
export TEAM_AGENT=leaderboard/team_code/contrastiveFC_agent.py
export TEAM_CONFIG=models/
